    ...
    <HRPage title="Payment Settings" subtitle="Configure payment module preferences">
      ...
      <div className="space-y-6">
        ...
        <div className="border-t border-slate-200 pt-6">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Dunning Configuration</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border-t border-slate-200 pt-6">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Collections Configuration</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border-t border-slate-200 pt-6">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Refund & Receipt Configuration</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
