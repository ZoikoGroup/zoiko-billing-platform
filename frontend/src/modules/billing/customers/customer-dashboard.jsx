            ...
            <div className="flex flex-col items-center justify-center h-64 text-gray-400">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6 w-full max-w-sm">
                ...
                <div className="text-center p-2 bg-blue-50 rounded-lg">
                  <p className="text-lg font-bold text-blue-700 truncate" title={formatDisplayCurrency(d.credit_notes_total || 0, baseCurrency)}>{formatDisplayCurrency(d.credit_notes_total || 0, baseCurrency)}</p>
                  <p className="text-xs text-blue-600">Credit Notes</p>
                </div>
                <div className="text-center p-2 bg-red-50 rounded-lg">
                  <p className="text-lg font-bold text-red-700 truncate" title={formatDisplayCurrency(d.refunds_total || 0, baseCurrency)}>{formatDisplayCurrency(d.refunds_total || 0, baseCurrency)}</p>
