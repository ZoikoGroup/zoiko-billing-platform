        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <ResponsiveContainer width="100%" height={380}>
            <LineChart data={forecast.combinedChart} margin={{ top: 10, right: 30, left: 10, bottom: 5 }}>
              ...
              <Legend />
              <Line type="monotone" dataKey="Revenue" stroke="var(--color-brand)" strokeWidth={2} dot={false} connectNulls={false} name="Revenue (Historical)" />
              <Line type="monotone" dataKey="Forecast" stroke="var(--color-brand)" strokeWidth={2} strokeDasharray="8 4" dot={false} connectNulls={false} name="Revenue (Forecast)" />
