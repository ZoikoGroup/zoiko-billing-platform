...
// ExecutiveSummary lives in its own recharts-free module (executive-summary.jsx)
// so shared chains do not pull billing-ui just for the insight strip. Re-exported
// here for backward compatibility — see the file docstring there.
...
export function Modal({
  ...
  useEffect(() => {
    ...
    // restored on close (e.g. the "New Organization" button that triggered it).
