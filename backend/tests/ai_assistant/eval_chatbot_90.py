...
CASES = [
    ...
    ("Show recent payments", {"intent": "payment_list"}),
    ...
    ("Show me Gok's outstanding balance", {"intent": "account_balance"}),
    ...
    ("Search invoice INV-2024-0002", {"intent": "invoice_search"}),
    ...
    ("Monthly revenue", {"intent": "metric_paid_period"}),
    ("Earnings overview", {"intent": "clarify_dashboard_scope"}),
    ("Show financial summary", {"domain": "dashboard"}),
    ...
    ("Explain payment reconciliation", {"intent": "help_general"}),
    ...
    ("Hello", {"mode": "M0_EXPLAIN"}),
    ("asdasd qwezxc", {"intent": "out_of_scope"}),
    ("Thanks", {"mode": "M0_EXPLAIN"}),
    ("Goodbye", {"mode": "M0_EXPLAIN"}),
    # ── Context / misc ───────────────────────────────────────────────────────
