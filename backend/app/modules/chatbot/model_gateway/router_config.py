...
def get_model_config(task_class: str) -> ModelConfig:
    """Resolve model config for a task class, falling back to answer_generation."""
    return TASK_MODEL_ROUTING.get(task_class, TASK_MODEL_ROUTING["answer_generation"])
